...
class AIService {
  ...
  static Future<List<dynamic>> fetchAIDatasets() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/datasets'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data['data'] ?? [];
      }
  ...
  static Future<List<dynamic>> fetchAIPapers() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/papers'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data['data'] ?? [];
      }
  ...
  static Future<List<dynamic>> fetchAINews() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/news'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data['data'] ?? [];
      }
  ...
  static Future<List<dynamic>> fetchAICommunity() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/community'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data['data'] ?? [];
      }
  ...
  static Future<List<dynamic>> fetchAIRepos() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/repos'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data['data'] ?? [];
      }
  ...
  static Future<Map<String, dynamic>> fetchAIDashboard() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/dashboard'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data['data'] ?? {};
      }
  ...
  static Future<Map<String, dynamic>> fetchAllAIData() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/ai/all'));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
        return data;
      }
